...
[![Coverage Status](https://coveralls.io/repos/OnroerendErfgoed/pyoes/badge.png?branch=master)](https://coveralls.io/r/OnroerendErfgoed/pyoes)
[![Documentation Status](https://readthedocs.org/projects/pyoes/badge/?version=latest)](https://readthedocs.org/projects/pyoes/?badge=latest)
[![PyPI version](https://badge.fury.io/py/pyoes.png)](http://badge.fury.io/py/pyoes)
...
Deze repo gebruikt [mise](https://mise.jdx.dev/) om de project setup zo simpel
mogelijk te maken.
...
be build using [Sphinx](http://sphinx-doc.org).
